/*!
 * 日期控件 lhgcore Calendar Plugin v3.0.0
 * kehFix:20140219
 */
$(function() {
//日期控件初始化调用
    $('#date_input_min').calendar({});
    $('#date_input_max').calendar({ minDate: '#date_input_min'});
});
;(function( $, window, undefined ){
    ...
    var document = window.document, _box,
        ...
        calendarTpl =
            ...
            '<tr>' +
            '<td><a class="cui_pm" href="javascript:void(0);"></a></td>' +
            '<td><input class="cui_im" maxlength="4" value=""/>月</td>' +
            '<td><a class="cui_nm" href="javascript:void(0);"></a></td>' +
            '<td><a class="cui_py" href="javascript:void(0);"></a></td>' +
            '<td><input class="cui_iy" maxlength="4" value=""/>年</td>' +
            '<td><a class="cui_ny" href="javascript:void(0);"></a></td>' +
            '</tr>' +
            '</table>' +
